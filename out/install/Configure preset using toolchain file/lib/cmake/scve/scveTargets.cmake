...
foreach(_cmake_expected_target IN ITEMS scve::scve)
...
# Create imported target scve::scve
add_library(scve::scve STATIC IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/scveTargets-*.cmake")
